...
const steps: MethodologyStep[] = [
  {
    title: 'Discord',
    description: 'Coordinación de sesiones técnicas para revisar enfoques y resolver dudas.',
    icon: MessageSquare,
    tag: 'Sesiones técnicas',
    time: 'Según convocatoria',
  },
  {
    title: 'WhatsApp',
    ...
    time: 'Comunicación asíncrona',
  },
  {
    title: 'Laboratorios',
    description: 'Intercambio de metodología y evidencias de laboratorios autorizados.',
    icon: GraduationCap,
