...
import { ArrowUp, UserCheck, Zap } from 'lucide-react';
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-8 pb-8 border-b border-slate-800">
          ...
          <div className="flex items-center gap-4">
            <a
              ...
              className="inline-flex items-center gap-2 px-4 py-2.5 rounded-xl bg-slate-950 hover:bg-slate-800 border border-slate-800 text-slate-200 text-sm font-medium transition-all shadow-md group"
            >
