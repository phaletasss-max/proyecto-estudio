...
export const LearningPerks: React.FC = () => {
  return (
    <section className="py-16 relative z-10 bg-transparent border-y border-slate-800/60">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="group relative rounded-3xl bg-slate-900 border border-slate-800 p-8 hover:border-blue-500/60 transition-colors flex flex-col justify-between">
            <div>
              <div className="w-14 h-14 rounded-2xl bg-blue-950 border border-blue-500/30 text-cyan-400 flex items-center justify-center mb-6">
          ...
          <div className="group relative rounded-3xl bg-slate-900 border border-slate-800 p-8 hover:border-purple-500/60 transition-colors flex flex-col justify-between">
            <div>
              <div className="w-14 h-14 rounded-2xl bg-purple-950 border border-purple-500/30 text-purple-400 flex items-center justify-center mb-6">
          ...
          <div className="group relative rounded-3xl bg-slate-900 border border-slate-800 p-8 hover:border-emerald-500/60 transition-colors flex flex-col justify-between">
            <div>
              <div className="w-14 h-14 rounded-2xl bg-emerald-950 border border-emerald-500/30 text-emerald-400 flex items-center justify-center mb-6">
