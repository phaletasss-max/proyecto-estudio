...
export const LEARNING_PATHS: LearningPath[] = [
  PROGRAMMING_PATH,
  {
    ...
    description: 'Aprende a investigar archivos, recuperar mensajes y justificar una flag. Comienza con retos locales guiados, sin máquinas virtuales.',
    icon: 'target',
    level: 'Fundamental',
    estimatedHours: 3,
    ...
    modules: [
      {
        id: 'm1',
        title: 'LootStash: tu primera evidencia en un archivo',
        description: 'Lee un archivo como datos y encuentra una flag con Python. No necesitas Linux ni ejecutar el programa del reto.',
        labSlug: 'htb-lootstash',
        type: 'lab',
        durationMinutes: 25,
        points: 100,
      },
      {
        id: 'm4',
        title: 'Dynastic: entiende e invierte un cifrado',
        description: 'Sigue un ejemplo pequeño, invierte la transformación y comprueba el mensaje recuperado.',
        labSlug: 'htb-dynastic',
        type: 'lab',
        durationMinutes: 30,
        points: 100,
      },
